import { Button, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, FormControlLabel, FormLabel, MenuItem, Radio, RadioGroup, Stack, TextField } from '@mui/material';
...
const InputModal = ({showModal, handleClose, dayData = 'mon', startTimeData = 9, endTimeData = 10, lectureNameData = '', lectureColorData = '#00ff55', idNum}) => {
  ...
  },[showModal, reset, lectureNameData, dayData, startTimeData, endTimeData, lectureColorData])
        ...
        <DialogContent style={{width: "400px"}}>
          ...
          <Stack spacing={3} style={{marginTop: "30px", width: "350px"}}>
              ...
              {errors.startTime?.type === "required" && (
                 <p style={{color: "#d32f2f"}}>강의 시작 시간을 선택</p>
              )}
             <Controller 
                control={control}
                name='endTime'
              ...
              {errors.endTime?.type === "required" && (
                 <p style={{color: "#d32f2f"}}>강의 종료 시간을 선택</p>
              )}     
              {errors.endTime?.type === "validate" && (
                 <p style={{color: "#d32f2f"}}>시작 시간과 종료 시간을 확인해주세요.</p>
              )}                            
          </Stack>
